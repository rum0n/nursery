...
class SslCommerzPaymentController extends Controller
{
    ...
    */
    ...
    {
        $order = Order::find($id);
        return view('user.pay_now',compact('order'));
    }


    public function pay_pending_bill(Request $request, $id)
    {
//        dd($request->all(),$id);
...
//        $user_id = Auth::user()->id;
        ...
        $post_data['tree_id'] = $order->tree_id;
        $post_data['owner_id'] = $order->owner_id;
    ...
    */
    ...
    {
        $tree = Tree::find($id);
        return view('exampleHosted',compact('tree'));
    }
...
//        dd($request->all(),$id);
        # Here you have  receive all the order data to initate the payment.
        # Let's say, your oder transaction informations are saving in a table called "orders"
        # In "orders" table, order unique identity is "transaction_id". "status" field contain status of the transaction, "amount" is the order amount to be paid and "currency" is for storing Site Currency which will be checked with paid currency.
        ...
        $post_data['tree_id'] = $tree->id;
        $post_data['owner_id'] = $tree->user_id;
...
//                echo "<br >Transaction is successfully Completed";
                Toastr::success('Your Purchase Completed !' ,'Congratulation');
