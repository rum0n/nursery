                ...
                <table class="table table-bordered table-responsive">
                    ...
                    @foreach($orders as $x)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.order.show',$x->id) }}" class="btn btn-primary btn-sm ml-1" title="See Details"><i class="fa fa-eye"></i></a>
                                ...
                                <form id="delete-form-{{ $x->id }}" action="{{ route('admin.order.destroy',$x->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                </form>
